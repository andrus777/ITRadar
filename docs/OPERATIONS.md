...
`source_run` каждого источника, его `health` (`healthy`, `degraded`, `unhealthy`),
счётчики полученных, новых, дублирующихся и отклонённых карточек, а также время
последнего успешного запуска и ошибки.
